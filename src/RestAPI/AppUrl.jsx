class AppUrl{
    ...
    static TotalClient= this.BaseUrl+'/TotalClient';
    ...
    static Serveices= this.BaseUrl+'/Serveices';
    static Serveices3= this.BaseUrl+'/Serveices3';
    ...
    static AboutInfometion = this.BaseUrl+'/Information';
    static NewData = this.BaseUrl+'/newData';
